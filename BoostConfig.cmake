...
macro(boost_find_all_components req)
  ...
  foreach(__boost_comp IN LISTS __boost_all_components)
    ...
    string(TOUPPER ${__boost_comp} _BOOST_COMP)
  ...
  #  list(REMOVE_DUPLICATES Boost_ALL_TARGETS)
...
if(NOT TARGET Boost::boost)
  ...
  if(DEFINED Boost_ALL_TARGETS)
    ...
    list(APPEND Boost_ALL_TARGETS Boost::boost)
    list(APPEND Boost_ALL_TARGETS Boost::diagnostic_definitions)
    list(APPEND Boost_ALL_TARGETS Boost::disable_autolinking)
    list(APPEND Boost_ALL_TARGETS Boost::dynamic_linking)
